...
const mt4Connector=await fs.readFile('downloads/TradeJournalConnector_MT4_v1.15.mq4','utf8');
ok(mt4Connector.includes('#property version   "1.15"'),'MT4 connector: wrong version');
...
ok(html.includes("LATEST_MT4_CONNECTOR='1.15'"),'index.html: latest MT4 connector version is not 1.15');
